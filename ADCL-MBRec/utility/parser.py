...
def parse_args():
    parser = argparse.ArgumentParser(description="Run ADCL-MBRec.")
    ...
    parser.add_argument('--embed_size', type=int, default=128,   #common parameterZA
                        help='Embedding size.')
    parser.add_argument('--layer_size', nargs='?', default='[128,128]', #common parameter
    ...
    parser.add_argument('--coefficient', nargs='?', default='[1.0/6, 4.0/6, 1.0/6]',
                        help='Regularization, [0.0/6, 5.0/6, 1.0/6] for beibei, [1.0/6, 4.0/6, 1.0/6] for taobao')

    parser.add_argument('--mess_dropout', nargs='?', default='[0.5]',
